...
import 'package:movie_app/core/errors/remote/trending_exception.dart';
...
class TrendingDateSource implements MoviesDataSource {
  TrendingDateSource(this._dio);
  final Dio _dio;
  @override
  Future<SectionsMoviesResponse> getMovies([int page=1]) async {
    try {
      Response response = await _dio.get(ApiConsts.trendingEndpoint,queryParameters: {"page":page});
